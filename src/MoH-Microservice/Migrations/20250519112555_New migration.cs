...
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
...
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
...
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
                values: new object[] { "5d670fdf-7976-4a5c-bed4-652ffc532b1b", 0, "dfb5041c-f148-4df5-92ae-7cc1faa10429", "Tsedey Bank", "dereje.hmariam@tsedeybank.com.et", true, "", false, null, "DEREJE.HMARIAM@TSEDEYBANK.COM.ET", "DEREJEH", "AQAAAAIAAYagAAAAEJMBA0v6pOmED9MWu/AimKNMmJjlNzjQ6mvWUX4Wbt+eGFJs/5jooDkRB0IUWz74gA==", "+251912657147", true, "0df292fc-16c3-4284-955f-22a92332707f", false, "DerejeH", "Admin" });
========
                values: new object[] { "a33c5ed2-f9fe-4a4f-a45b-c2f17e50ca37", 0, "944a5b78-2b04-45d7-8c25-150b34fd3459", "Tsedey Bank", "dereje.hmariam@tsedeybank.com.et", true, "", false, null, "DEREJE.HMARIAM@TSEDEYBANK.COM.ET", "DEREJEH", "AQAAAAIAAYagAAAAEP2XDQUwwCJ8jqu9l4iuIUs0eMmaf7oHmr7yBtsu2lHegabFow5IzJjw9S3+wiX8Kw==", "+251912657147", true, "31d87e6d-bd6e-4f68-a4df-6e92292fadf8", false, "DerejeH", "Admin" });
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
                    { 1, "TeleBirr", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1229), null, null },
                    { 2, "CBE Mobile Banking", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1231), null, null },
                    { 3, "Awash Bank", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1234), null, null },
                    { 4, "Bank of Abyssinia", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1235), null, null },
                    { 5, "Amhara Bank", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1238), null, null },
                    { 6, "Tsedey Bank", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1239), null, null },
                    { 7, "Other", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1241), null, null },
                    { 8, "Chapa", "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1243), null, null }
========
                    { 1, "TeleBirr", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6016), null, null },
                    { 2, "CBE Mobile Banking", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6018), null, null },
                    { 3, "Awash Bank", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6019), null, null },
                    { 4, "Bank of Abyssinia", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6020), null, null },
                    { 5, "Amhara Bank", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6022), null, null },
                    { 6, "Tsedey Bank", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6023), null, null },
                    { 7, "Other", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6024), null, null },
                    { 8, "Chapa", "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(6026), null, null }
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
                    { 1, null, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1183), "Card/ካርድ", null, null },
                    { 2, null, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1187), "Medicne/መድሃኒት", null, null },
                    { 3, null, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1189), "Laboratory/ላብራቶሪ", null, null },
                    { 4, null, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1191), "Rag/X-RAY/ራጅ፣አልትራሳውንድ", null, null },
                    { 5, null, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1193), "Others/ሌሎች", null, null }
========
                    { 1, null, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5990), "Card/ካርድ", null, null },
                    { 2, null, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5991), "Medicne/መድሃኒት", null, null },
                    { 3, null, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5993), "Laboratory/ላብራቶሪ", null, null },
                    { 4, null, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5994), "Rag/X-RAY/ራጅ፣አልትራሳውንድ", null, null },
                    { 5, null, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5996), "Others/ሌሎች", null, null }
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
                    { 1, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1099), null, null, "ALL" },
                    { 2, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1102), null, null, "CASH" },
                    { 3, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1105), null, null, "CBHI" },
                    { 4, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1107), null, null, "Credit" },
                    { 5, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1109), null, null, "Free of Charge" },
                    { 6, "SYS", new DateTime(2025, 5, 19, 14, 25, 53, 891, DateTimeKind.Local).AddTicks(1111), null, null, "Digital" }
========
                    { 1, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5874), null, null, "ALL" },
                    { 2, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5876), null, null, "CASH" },
                    { 3, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5878), null, null, "CBHI" },
                    { 4, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5879), null, null, "Credit" },
                    { 5, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5954), null, null, "Free of Charge" },
                    { 6, "SYS", new DateTime(2025, 5, 20, 11, 24, 50, 418, DateTimeKind.Local).AddTicks(5956), null, null, "Digital" }
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
                });
...
<<<<<<<< HEAD:src/MoH-Microservice/Migrations/20250519112555_New migration.cs
                values: new object[] { "1", "5d670fdf-7976-4a5c-bed4-652ffc532b1b" });
========
                values: new object[] { "1", "a33c5ed2-f9fe-4a4f-a45b-c2f17e50ca37" });
>>>>>>>> a8282563e1e242b2fe9769dbf222f5a923e73ea8:src/MoH-Microservice/Migrations/20250520142451_init.cs
