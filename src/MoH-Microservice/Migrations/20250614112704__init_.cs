    ...
    public partial class _init_ : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "TeleBirr", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8197), null, null },
                    { 2, "CBE Mobile Banking", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8200), null, null },
                    { 3, "Awash Bank", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8202), null, null },
                    { 4, "Bank of Abyssinia", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8211), null, null },
                    { 5, "Amhara Bank", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8212), null, null },
                    { 6, "Tsedey Bank", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8214), null, null },
                    { 7, "Other", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8218), null, null },
                    { 8, "Chapa", "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8220), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8144), "Card/ካርድ", null, null },
                    { 2, null, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8146), "Medicne/መድሃኒት", null, null },
                    { 3, null, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8148), "Laboratory/ላብራቶሪ", null, null },
                    { 4, null, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8150), "Rag/X-RAY/ራጅ፣አልትራሳውንድ", null, null },
                    { 5, null, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8151), "Others/ሌሎች", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(7989), null, null, "ALL" },
                    { 2, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(7996), null, null, "CASH" },
                    { 3, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(7998), null, null, "CBHI" },
                    { 4, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8000), null, null, "Credit" },
                    { 5, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8001), null, null, "Free of Charge" },
                    { 6, "SYS", new DateTime(2025, 6, 14, 8, 27, 2, 856, DateTimeKind.Local).AddTicks(8003), null, null, "Digital" }
                });
